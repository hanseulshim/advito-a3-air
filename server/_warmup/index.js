...
/** Generated by Serverless WarmUp Plugin at 2019-05-02T20:48:38.549Z */
const aws = require("aws-sdk");
aws.config.region = "us-east-2";
const lambda = new aws.Lambda();
const functions = [{"name":"air-server-test-graphql","config":{"enabled":true,"payload":"{\"source\":\"serverless-plugin-warmup\"}","concurrency":1}}];
