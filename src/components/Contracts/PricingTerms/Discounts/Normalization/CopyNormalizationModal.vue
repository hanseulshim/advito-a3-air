  ...
  >
    ...
    >
      <div class="title-row space-between">
        <div class="section-header">copy normalization</div>
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      this.$refs.copyNormalization.validate(valid => {
        if (valid) {
          this.copyNormalization();
        } else {
          return false;
        }
      });
    ...
    async copyNormalization() {
      ...
      //         ...this.form
      //       },
      //       update: (store, { data: { copyNormalization } }) => {
      //         const query = {
      ...
      //         data.normalizationList.push(copyNormalization);
      //         store.writeQuery({
      //           ...query,
      //           data
      //         });
